...
class TxTypeUi(tk.Toplevel):
    def __init__(self):
        super().__init__()

        self.title("Tratamentos - Clinica de Odontologia")
        ...
        # Title
        ttk.Label(
            self, text=' Lista de Tipos de Tratamentos', style="Title.TLabel"
    ...
    def create_center(self) -> ttk.Frame:
        ...
        self.tbl_1.heading('#3', text='Status', anchor='w')
