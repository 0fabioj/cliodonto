...
class GraduatingUi(tk.Toplevel):
    def __init__(self):
        super().__init__()

        self.title("Turmas - Clinica de Odontologia")
        ...
        # Title
        ttk.Label(
            self, text=' Lista de Turmas', style="Title.TLabel"
    ...
    def create_center(self) -> ttk.Frame:
        ...
        colsdata = ('id','name','semester','year','enrolled')
        ...
        self.tbl_1.heading('#3', text='Semestre', anchor='w')
        self.tbl_1.heading('#4', text='Ano', anchor='w')
        self.tbl_1.heading('#5', text='Matriculados', anchor='w')
        
        self.tbl_1.column('#1', minwidth=0, width=0, stretch=False)
        self.tbl_1.column('#2', minwidth=60, stretch=True)
        self.tbl_1.column('#3', minwidth=20, width=80, stretch=False)
        self.tbl_1.column('#4', minwidth=20, width=80, stretch=False)
