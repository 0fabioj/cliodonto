...
class TeachersUi(tk.Toplevel):
    def __init__(self):
        super().__init__()

        self.title("Professores - Clinica de Odontologia")
        ...
        # Title
        ttk.Label(
            self, text=' Lista de Professores', style="Title.TLabel"
    ...
    def create_center(self) -> ttk.Frame:
        ...
        colsdata = ('id','nome','email','phone','cro','status')
        ...
        self.tbl_1.heading('#3', text='Email', anchor='w')
        self.tbl_1.heading('#4', text='Telefone', anchor='w')
        self.tbl_1.heading('#5', text='CRO', anchor='w')
        self.tbl_1.heading('#6', text='Status', anchor='w')
        
        self.tbl_1.column('#1', minwidth=30, width=70, stretch=False)
        self.tbl_1.column('#2', minwidth=60, stretch=True)
        self.tbl_1.column('#3', minwidth=10, width=200, stretch=False)
        self.tbl_1.column('#4', minwidth=20, width=120, stretch=False)
        self.tbl_1.column('#5', minwidth=20, width=120, stretch=False)
        self.tbl_1.column('#6', minwidth=20, width=60, stretch=False)
