...
class StudentUi(tk.Toplevel):
    def __init__(self):
        super().__init__()

        self.title("Alunos - Clinica de Odontologia")
        ...
        # Title
        ttk.Label(
            self, text=' Lista de Alunos', style="Title.TLabel"
    ...
    def create_center(self) -> ttk.Frame:
        ...
        colsdata = ('id','nome','email','phone','status')
        ...
        self.tbl_1.heading('#5', text='Situação', anchor='w')
        ...
        self.tbl_1.column('#5', minwidth=20, width=60, stretch=False)
